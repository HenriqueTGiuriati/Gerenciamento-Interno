<div class="box">
            ...
            <div class="box-body">
              <table class="table table-bordered">
                <tbody><tr>
                  <th>Membros (A-Z)</th>
                  <th style="width: 200px">Diretoria</th>
                  <th>Horários</th>
                  <th style="width: 150px">Presença</th>
                  <th style="width: 150px">Presença mensal</th>
                </tr>
                <tr>
                  <td>Gustavo Henrique Barbosa</td>
                  <td>Projetos (Internos)</td>
                  <td>Terça-feira (12:00PM - 02:00PM)</td>
                  <td>                     
             <div class="form-group">
              ...
              <td><span class="badge bg-yellow">70%</span></td>
                                ...
                                <tr>
                  <td>Lucas Roberto de Souza Silva</td>
                  <td>Projetos (Internos)</td>
                   <td>Terça-feira (12:00PM - 02:00PM)</td>
                  <td>                     
             <div class="form-group">
              ...
              <td><span class="badge bg-red-gradient">90%</span></td>
                  </td>                
                </tr>
             ...
             <div class="form-group">
              ...
              <td><span class="badge bg-light-blue">80%</span></td>
                ...
                <tr>
                  <td>Verônica Silva</td>
                  <td> Recursos Humanos</td>
                   <td>Quinta-feira (02:00PM - 04:00PM)</td>
                  <td>                     
             <div class="form-group">
                <label>
                  <div class="icheckbox_flat-green checked" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="checkbox" class="flat-red" checked="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"></ins></div>
              ...
              <td><span class="badge bg-yellow-active">60%</span></td>
                  </td>                
                </tr>
              </tbody></table>
            </div>
